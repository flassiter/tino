...
class TestComponentRegistry:
    ...
    def test_register_component_with_factory(self):
        ...
        self.registry.register_component("test_a", MockComponentA, factory=mock_factory_a)
    ...
    def test_register_component_with_dependencies(self):
        ...
        self.registry.register_component("test_a", MockComponentA)
        self.registry.register_component("test_b", MockComponentB, dependencies=["test_a"])
    ...
    def test_circular_dependency_detection(self):
        ...
        self.registry.register_component("test_a", MockComponentA, dependencies=["test_b"])
        self.registry.register_component("test_b", MockComponentB, dependencies=["test_a"])
    ...
    def test_initialization_order_resolution(self):
        ...
        self.registry.register_component("test_c", MockComponentC, dependencies=["test_b"])
        self.registry.register_component("test_a", MockComponentA)
        self.registry.register_component("test_b", MockComponentB, dependencies=["test_a"])
    ...
    def test_validate_dependencies(self):
        ...
        # Invalid dependency
        self.registry.register_component("test_bad", MockComponentA, dependencies=["nonexistent"])
    ...
    def test_component_creation_error(self):
        ...
        self.registry.register_component("test_fail", MockComponentA, factory=failing_factory)
