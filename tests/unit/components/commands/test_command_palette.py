...
class TestCommandPalette:
    ...
    def setup_method(self):
        ...
        self.mock_registry.get_command.side_effect = lambda name: self.mock_commands.get(name)
...
class TestCommandPaletteIntegration:
    ...
    def setup_method(self):
        ...
        self.commands = {
            "file.new": self._create_mock_command("New File", "Create a new file", "file", "ctrl+n"),
            "file.open": self._create_mock_command("Open File", "Open an existing file", "file", "ctrl+o"),
            "file.save": self._create_mock_command("Save File", "Save the current file", "file", "ctrl+s"),
            "edit.undo": self._create_mock_command("Undo", "Undo last action", "edit", "ctrl+z"),
            "edit.redo": self._create_mock_command("Redo", "Redo last undone action", "edit", "ctrl+y"),
            "view.preview": self._create_mock_command("Toggle Preview", "Show/hide preview pane", "view", "f2"),
        }
        
        self.mock_registry.get_all_commands.return_value = self.commands
        self.mock_registry.get_command.side_effect = lambda name: self.commands.get(name)
