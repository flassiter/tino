...
from src.tino.core.events.types import FileOpenedEvent, FileSavedEvent, FileClosedEvent
...
class TestOpenFileCommand(TestFileCommandsBase):
    ...
    def test_execute_success_with_path_arg(self):
        ...
        self.mock_file_manager.get_file_info.return_value = (1024, "2024-01-01", "utf-8")  # size, modified, encoding
...
class TestSaveFileCommand(TestFileCommandsBase):
    ...
    def test_execute_success_existing_file(self):
        ...
        self.mock_file_manager.save_file.assert_called_once_with(test_path, "File content")
        self.mock_editor.set_modified.assert_called_once_with(False)
    ...
    def test_execute_no_current_file_prompts_save_as(self):
        ...
        with patch('src.tino.components.commands.file_commands.SaveAsFileCommand') as mock_save_as:
...
class TestSaveAsFileCommand(TestFileCommandsBase):
    ...
    def test_execute_success(self):
        ...
        # Verify save operation
        self.mock_file_manager.save_file.assert_called_once_with(new_path, "File content")
...
class TestLastFileCommand(TestFileCommandsBase):
    ...
    def test_execute_success(self):
        ...
        with patch('src.tino.components.commands.file_commands.OpenFileCommand') as mock_open:
...
class TestFileCommandsIntegration(TestFileCommandsBase):
    ...
    def test_open_then_save_workflow(self):
        ...
        assert result is True
        self.mock_file_manager.save_file.assert_called_with(test_path, "Modified content")