...
class TestEncodingDetector:
    ...
    def test_can_decode_method(self):
        ...
        assert not self.detector._can_decode(
            utf8_data, "ascii"
        )  # UTF-8 chars can't be ASCII
    ...
    def test_binary_file_signatures(self):
        ...
        for signature, file_type in test_cases:
            ...
            assert self.detector.is_binary_data(
                data
            ), f"Failed to detect {file_type} as binary"
    ...
    def test_confidence_scoring(self):
        ...
        high_conf_data = "Hello, 世界! 🌍".encode()
