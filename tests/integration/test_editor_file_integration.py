...
from tino.components.editor import MockEditor
from tino.components.file_manager import FileManager
from tino.core.events.bus import EventBus
from tino.core.events.types import FileOpenedEvent, FileSavedEvent, TextChangedEvent
...
class TestEditorFileManagerIntegration:
    ...
    def test_cursor_position_memory_integration(self):
        ...
        remembered_line, remembered_column = self.file_manager.get_cursor_position(
            test_file
        )
