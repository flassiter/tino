...
class MockFileManager(IFileManager):
    ...
    def clear_error_simulation(self, operation: str | None = None) -> None:
        """
    ...
    def open_file(self, file_path: Path) -> str:
        ...
        self._record_operation(
            "open_file", file_path, encoding=encoding, size=len(content)
        )
    ...
    def save_file(
        ...
        if file_path in self._files and file_path not in self._backed_up_this_session:
