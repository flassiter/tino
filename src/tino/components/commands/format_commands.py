...
from ...core.events.types import TextChangedEvent
...
class BoldCommand(EditorCommand):
    ...
    def execute(self, *args: Any, **kwargs: Any) -> bool:
        ...
        try:
            ...
            raise CommandError(
                f"Failed to apply bold formatting: {e}", self.get_name(), e
            )
...
class ItalicCommand(EditorCommand):
    ...
    def execute(self, *args: Any, **kwargs: Any) -> bool:
        ...
        try:
            ...
            raise CommandError(
                f"Failed to apply italic formatting: {e}", self.get_name(), e
            )
...
class CodeCommand(EditorCommand):
    ...
    def execute(self, *args: Any, **kwargs: Any) -> bool:
        ...
        try:
            ...
            raise CommandError(
                f"Failed to apply code formatting: {e}", self.get_name(), e
            )
...
class LinkCommand(EditorCommand):
    ...
    def execute(self, *args: Any, **kwargs: Any) -> bool:
        ...
        try:
            ...
            raise CommandError(f"Failed to insert link: {e}", self.get_name(), e) from e
    ...
    def _parse_link(self, text: str) -> tuple[str, str] | None:
...
class HeadingCommand(EditorCommand):
    ...
    def execute(self, *args: Any, **kwargs: Any) -> bool:
        ...
        try:
            ...
            raise CommandError(f"Failed to apply heading: {e}", self.get_name(), e) from e
...
class StrikethroughCommand(EditorCommand):
    ...
    def execute(self, *args: Any, **kwargs: Any) -> bool:
        ...
        try:
            ...
            raise CommandError(
                f"Failed to apply strikethrough: {e}", self.get_name(), e
            )
