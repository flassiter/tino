...
class CommandPalette:
    ...
    def search_commands(
        self, query: str, category: str | None = None, include_recent: bool = True
    ...
    def _calculate_score(
        self, query: str, command_info: dict[str, Any]
    ) -> tuple[float, str]:
        """
...
class CommandAutoComplete:
    ...
    def get_parameter_completions(
        self, command_name: str, parameter: str, partial: str
    ) -> list[str]:
        """
        ...
        if param_type == "boolean":
            ...
            matching = [
                cat for cat in categories if cat.lower().startswith(partial.lower())
            ]
            return matching
