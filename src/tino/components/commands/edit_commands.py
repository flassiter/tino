...
from ...core.events.types import SelectionChangedEvent, TextChangedEvent
...
class UndoCommand(EditorCommand):
    ...
    def execute(self, *args: Any, **kwargs: Any) -> bool:
        ...
        try:
            ...
            self._store_execution_data(
                "cursor_before_undo", (current_cursor[0], current_cursor[1])
            )
            ...
            if success:
                ...
                event = TextChangedEvent(
                    content=new_content, old_content=current_content, change_type="undo"
                )
            ...
            raise CommandError(f"Failed to undo: {e}", self.get_name(), e) from e
    ...
    def can_execute(self, *args: Any, **kwargs: Any) -> bool:
        ...
        return super().can_execute(*args, **kwargs) and self.editor.can_undo()
...
class RedoCommand(EditorCommand):
    ...
    def execute(self, *args: Any, **kwargs: Any) -> bool:
        ...
        try:
            ...
            if success:
                ...
                new_content = self.editor.get_content()
                event = TextChangedEvent(
                    content=new_content, old_content=current_content, change_type="redo"
                )
                self._emit_event(event)
            ...
            raise CommandError(f"Failed to redo: {e}", self.get_name(), e) from e
    ...
    def can_execute(self, *args: Any, **kwargs: Any) -> bool:
        ...
        return super().can_execute(*args, **kwargs) and self.editor.can_redo()
...
class CutCommand(EditorCommand):
    ...
    def execute(self, *args: Any, **kwargs: Any) -> bool:
        ...
        try:
            ...
            raise CommandError(f"Failed to cut text: {e}", self.get_name(), e) from e
...
class CopyCommand(EditorCommand):
    ...
    def execute(self, *args: Any, **kwargs: Any) -> bool:
        ...
        try:
            ...
            raise CommandError(f"Failed to copy text: {e}", self.get_name(), e) from e
...
class PasteCommand(EditorCommand):
    ...
    def execute(self, *args: Any, **kwargs: Any) -> bool:
        ...
        try:
            ...
            raise CommandError(f"Failed to paste text: {e}", self.get_name(), e) from e
    ...
    def can_execute(self, *args: Any, **kwargs: Any) -> bool:
        ...
        return super().can_execute(*args, **kwargs) and bool(
            self.context.application_state.get("clipboard", "")
        )
    ...
    def execute(self, *args: Any, **kwargs: Any) -> bool:
        ...
        try:
            ...
            event = SelectionChangedEvent(
                start=0, end=content_length, selected_text=self.editor.get_content()
            )
            self._emit_event(event)
            ...
            raise CommandError(f"Failed to select all: {e}", self.get_name(), e) from e
...
class DuplicateLineCommand(EditorCommand):
    ...
    def execute(self, *args: Any, **kwargs: Any) -> bool:
        ...
        try:
            ...
            raise CommandError(f"Failed to duplicate line: {e}", self.get_name(), e) from e
    ...
    def undo(self) -> bool:
        ...
        try:
            ...
            self._get_execution_data("line_text", "")  # Get stored line text
...
class DeleteLineCommand(EditorCommand):
    ...
    def execute(self, *args: Any, **kwargs: Any) -> bool:
        ...
        try:
            ...
            raise CommandError(f"Failed to delete line: {e}", self.get_name(), e) from e
