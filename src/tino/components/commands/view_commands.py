...
class TogglePreviewCommand(BaseCommand):
    ...
    def execute(self, *args: Any, **kwargs: Any) -> bool:
        ...
        try:
            ...
            preview_visible = self.context.application_state.get('preview_visible', True)
            ...
            raise CommandError(f"Failed to toggle preview: {e}", self.get_name(), e)
...
class ToggleLineNumbersCommand(BaseCommand):
    ...
    def execute(self, *args: Any, **kwargs: Any) -> bool:
        ...
        try:
            ...
            line_numbers_visible = self.context.application_state.get('line_numbers_visible', True)
            ...
            raise CommandError(f"Failed to toggle line numbers: {e}", self.get_name(), e)
...
class PreviewOnlyCommand(BaseCommand):
    ...
    def execute(self, *args: Any, **kwargs: Any) -> bool:
        ...
        try:
            ...
            old_layout = {
                'editor_visible': self.context.application_state.get('editor_visible', True),
                'preview_visible': self.context.application_state.get('preview_visible', True),
                'layout_mode': self.context.application_state.get('layout_mode', 'split')
            }
            ...
            raise CommandError(f"Failed to switch to preview only: {e}", self.get_name(), e)
    ...
    def undo(self) -> bool:
        ...
        try:
            ...
            # Trigger UI update
            self.context.application_state['ui_action'] = 'layout_change'
            self.context.application_state['ui_action_data'] = {'mode': old_layout.get('layout_mode', 'split')}
...
class ToggleThemeCommand(BaseCommand):
    ...
    def execute(self, *args: Any, **kwargs: Any) -> bool:
        ...
        try:
            ...
            raise CommandError(f"Failed to toggle theme: {e}", self.get_name(), e)
...
class CommandPaletteCommand(BaseCommand):
    ...
    def execute(self, *args: Any, **kwargs: Any) -> bool:
        ...
        try:
            ...
            raise CommandError(f"Failed to show command palette: {e}", self.get_name(), e)
...
class ShowSettingsCommand(BaseCommand):
    ...
    def execute(self, *args: Any, **kwargs: Any) -> bool:
        ...
        try:
            ...
            raise CommandError(f"Failed to show settings: {e}", self.get_name(), e)
...
class ShowHelpCommand(BaseCommand):
    ...
    def execute(self, *args: Any, **kwargs: Any) -> bool:
        ...
        try:
            ...
            raise CommandError(f"Failed to show help: {e}", self.get_name(), e)
...
class ToggleWordWrapCommand(BaseCommand):
    ...
    def execute(self, *args: Any, **kwargs: Any) -> bool:
        ...
        try:
            ...
            word_wrap_enabled = self.context.application_state.get('word_wrap_enabled', True)
            ...
            raise CommandError(f"Failed to toggle word wrap: {e}", self.get_name(), e)
...
class ToggleStatusBarCommand(BaseCommand):
    ...
    def execute(self, *args: Any, **kwargs: Any) -> bool:
        ...
        try:
            ...
            status_bar_visible = self.context.application_state.get('status_bar_visible', True)
            ...
            raise CommandError(f"Failed to toggle status bar: {e}", self.get_name(), e)
...
class ZoomInCommand(BaseCommand):
    ...
    def execute(self, *args: Any, **kwargs: Any) -> bool:
        ...
        try:
            ...
            raise CommandError(f"Failed to zoom in: {e}", self.get_name(), e)
...
class ZoomOutCommand(BaseCommand):
    ...
    def execute(self, *args: Any, **kwargs: Any) -> bool:
        ...
        try:
            ...
            raise CommandError(f"Failed to zoom out: {e}", self.get_name(), e)
