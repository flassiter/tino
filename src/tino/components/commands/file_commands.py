...
from ...core.events.types import FileOpenedEvent, FileSavedEvent, FileClosedEvent
...
class NewFileCommand(FileCommand):
    ...
    def execute(self, *args: Any, **kwargs: Any) -> bool:
        ...
        try:
            ...
            raise CommandError(f"Failed to create new file: {e}", self.get_name(), e)
...
class OpenFileCommand(FileCommand):
    ...
    def execute(self, *args: Any, **kwargs: Any) -> bool:
        ...
        try:
            ...
            # Store previous state for undo
            old_content = self.context.editor.get_content() if self.context.editor else ""
            ...
            raise CommandError(f"Failed to open file {file_path}: {e}", self.get_name(), e)
...
class SaveFileCommand(FileCommand):
    ...
    def execute(self, *args: Any, **kwargs: Any) -> bool:
        ...
        try:
            ...
            if self.context.editor:
                ...
                self.file_manager.set_cursor_position(file_path, cursor_pos[0], cursor_pos[1])
            ...
            raise CommandError(f"Failed to save file: {e}", self.get_name(), e)
    ...
    def can_execute(self, *args: Any, **kwargs: Any) -> bool:
        ...
        return (super().can_execute(*args, **kwargs) and 
                self.context.editor is not None)
...
class SaveAsFileCommand(FileCommand):
    ...
    def execute(self, *args: Any, **kwargs: Any) -> bool:
        ...
        try:
            ...
            raise CommandError(f"Failed to save file as {file_path}: {e}", self.get_name(), e)
...
class RecentFilesCommand(FileCommand):
    ...
    def execute(self, *args: Any, **kwargs: Any) -> bool:
        ...
        try:
            ...
            self.context.application_state["recent_files"] = [str(p) for p in recent_files]
            ...
            raise CommandError(f"Failed to get recent files: {e}", self.get_name(), e)
...
class LastFileCommand(FileCommand):
    ...
    def can_execute(self, *args: Any, **kwargs: Any) -> bool:
        ...
        try:
            return (super().can_execute(*args, **kwargs) and 
                    self.file_manager.get_last_file() is not None)
        except Exception:
            return False
...
class CloseFileCommand(FileCommand):
    ...
    def execute(self, *args: Any, **kwargs: Any) -> bool:
        ...
        try:
            ...
            raise CommandError(f"Failed to close file: {e}", self.get_name(), e)
