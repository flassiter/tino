...
class KeybindingManager:
    ...
    def __init__(self, event_bus: Optional[EventBus] = None):
        ...
        self._command_shortcuts: Dict[str, Set[str]] = defaultdict(set)  # command -> shortcuts
    ...
    def bind_key(self, shortcut: str, command_name: str, 
                 description: str = "", context: str = "global") -> bool:
        """
    ...
    def get_command_for_shortcut(self, shortcut: str, context: str = "global") -> Optional[str]:
        """
    ...
    def get_primary_shortcut(self, command_name: str) -> Optional[str]:
        """
    ...
    def validate_shortcut(self, shortcut: str) -> Tuple[bool, str]:
        ...
        try:
            ...
            for i, part in enumerate(original_parts[:-1]):  # All but last should be modifiers
