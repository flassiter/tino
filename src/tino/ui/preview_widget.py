...
from tino.core.interfaces.renderer import Heading, IRenderer
...
class MarkdownPreview(Widget):
    ...
    def __init__(
        self, renderer: IRenderer, name: str | None = None, id: str | None = None
    ) -> None:
        """
...
class PreviewUpdated(Message):
    ...
    def __init__(self, render_time: float, cached: bool, issues: list[Any]) -> None:
        """Initialize the message."""
        super().__init__()
